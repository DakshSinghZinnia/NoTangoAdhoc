...
public class ExprEval {
    ...
    private static List<List<Map.Entry<String, String>>> createConversionNodes() {
        ...
        barcode.add(entry("Barcode/value","(if(Document/System/SheetNo == 1 && Packaging/BannerFlag == 'True' || (Packaging/Mailing_Flag == 'show' && (Document/System/SheetNo == 1 || Document/System/SheetNo == 2)) || (Packaging/BannerFlag == 'True' && Packaging/Mailing_Flag == 'show' && (Document/System/SheetNo == 2 || Document/System/SheetNo == 3)),'', ('*'+if((Document/System/SheetNo)==(Document/System/SheetCount),1,0) + MaskNumber((ToInt(Divide(Document/System/PageNo,2))+Mod(Document/System/PageNo,2)),'###','000') + if(LessThan((DocInfo/DocCount),11),(DocInfo/DocCount-1),if(LessThan((DocInfo/DocCount),37),SubString('ABCDEFGHIJKLMNOPQRSTUVWXYZ',(DocInfo/DocCount-10),1),(DocInfo/DocCount))) + if(PlanCode_Lookup/ENV_BAR == '2', 'G', if(PlanCode_Lookup/ENV_BAR == '3', '8', if(PlanCode_Lookup/ENV_BAR == '4', '4', if(PlanCode_Lookup/ENV_BAR == '5', '2', '0')))) + if(PlanCode_Lookup/ENV_BAR == '6', 'G', if(PlanCode_Lookup/ENV_BAR == '7', '8', '0')) + '*')))"));
