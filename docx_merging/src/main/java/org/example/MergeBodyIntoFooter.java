...
public class MergeBodyIntoFooter {
    ...
    public static void main(String[] args) throws Exception {
        // --- Mac Downloads paths ---
        File resourcesDir = new File("docx_merging/src/main/resources");
        File srcHeaderFile = new File(resourcesDir, "srcHeader.docx");
        File srcFooterFile = new File(resourcesDir, "srcFooter.docx");
        File destFile      = new File(resourcesDir, "dest.docx");
        File outFile       = new File(resourcesDir, "dest-with-header-footer.docx");
